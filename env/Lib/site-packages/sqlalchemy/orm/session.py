    ...
    **Nesting and Subtransactions**
    ...
    def _remove_snapshot(self):
        ...
        if not self.nested and self.session.expire_on_commit:
            ...
            self._parent._new.update_user(self._new)
            self._parent._dirty.update_user(self._dirty)
            self._parent._deleted.update_user(self._deleted)
            self._parent._key_switches.update_user(self._key_switches)
