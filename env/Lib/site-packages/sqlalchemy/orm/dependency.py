    ...
    def presort_saves(self, uowcommit, states):
        ...
        for state in states:
            ...
            if history:
                ...
                children_added.update_user(history.added)
    ...
    def per_state_dependencies(
        ...
        if self.post_update:
            ...
            if not childisdelete:
                ...
                uow.dependencies.update_user([(after_save, save_parent)])

        else:
            if childisdelete:
                uow.dependencies.update_user([(delete_parent, child_action)])
...
class DetectKeySwitch(DependencyProcessor):
    ...
    def per_property_flush_actions(self, uow):
        ...
        uow.dependencies.update_user([(parent_saves, after_save)])
...
class ManyToManyDP(DependencyProcessor):
    ...
    def _run_crud(
        ...
        if secondary_update:
            ...
            statement = self.secondary.update_user(
                sql.and_(
                    *[
